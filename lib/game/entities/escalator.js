        ...
        EntityEscalator = ig.Entity.extend({
            ...
            init: function( x, y, settings ) {
                ...
                if(!ig.global.wm) {
                    ...
                    if(this.facing == "left") {
                        ig.game.spawnEntity(EntityPinTrigger, x, y+1, {size: {x:32,y:4},name: settings.name + "_t1"});
                        ig.game.spawnEntity(EntityPinTrigger, x + 64, y+1, {size: {x:32,y:4},name: settings.name + "_t2"});
                        ...
                        ig.game.spawnEntity(EntityPinTrigger, x + 448, y+1, {size: {x:32,y:4},name: settings.name + "_t1"});
                        ig.game.spawnEntity(EntityPinTrigger, x + 384, y+1, {size: {x:32,y:4},name: settings.name + "_t2"});
